...
var FadeMixin = require('react-bootstrap').FadeMixin;
...
var Modal = React.createClass({
  ...
  joinClasses: function(className/*, ... */) {
  if (!className) {
    className = '';
  }
  var nextClass;
  ...
  render: function () {
    ...
    var modal = (
      <div
        ...
        tabIndex="-1"
        role="dialog"
        className={this.joinClasses(this.props.className, this.classSet(classes))}
        onClick={this.props.backdrop === true ? this.handleBackdropClick : null}
        ref="modal">
        <div className={this.classSet(dialogClasses)}>
  ...
  renderBackdrop: function (modal) {
    ...
    return (
      <div>
        <div className={this.classSet(classes)} ref="backdrop" onClick={onClick} />
        {modal}
      </div>
    );
  },
  ...
  renderHeader: function () {
    ...
    var className = this.classSet(classes);
